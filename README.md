...
> 현재는 7/8버전이 나왔지만 6버전과 약간의 사용방법 차이가 있습니다.
> 7/8버전은 최상위 클래스명을 swiper-container 대신 swiper 로 지정해야 합니다.
...
[Swiper API](https://swiperjs.com/swiper-api)(옵션)을 확인할 수 있습니다.
